...
void Ray::generateVerticesAndNormals()
{
    vertices.push_back(start);
    vertices.push_back(currentPos(maxDistance));

    normals.push_back(MATH::Vec3(1.0f, 0.0f, 0.0f));
    normals.push_back(MATH::Vec3(1.0f, 0.0f, 0.0f));
...
void Ray::StoreMeshData(GLenum drawmode_)
{
    drawmode = drawmode_;
