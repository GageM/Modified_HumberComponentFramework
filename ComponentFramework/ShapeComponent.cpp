...
ShapeComponent::ShapeComponent(Ref<Component> parent_, Sphere sphere_) :Component(parent_)
{
...
ShapeComponent::ShapeComponent(Ref<Component> parent_, Cylinder cylinder_) :Component(parent_)
{
...
ShapeComponent::ShapeComponent(Ref<Component> parent_, Capsule capsule_) :Component(parent_)
{
...
// Capsule ShapeComponent Constructor: pass by value
ShapeComponent::ShapeComponent(Ref<Component> parent_, Box box_) :Component(parent_)
{
